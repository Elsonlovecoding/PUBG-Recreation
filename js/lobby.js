...
const TIPS = [
  ...
  'TIP: PRESS M FOR THE FULL ISLAND MAP WITH PLACE NAMES',
  'TIP: FALLING FROM THE 3RD STOREY OR HIGHER HURTS — 10 DAMAGE PER FLOOR',
  'TIP: NOVI PORT AND EASTVALE ARE RICH — AND EVERYONE KNOWS IT',
];
