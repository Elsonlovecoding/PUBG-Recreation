...
- Smooth analytic terrain normals (no more 4 m facets), a dense ring of ~11,000 gently swaying ankle-height grass clumps that streams around you and sinks away at its edge, baked ambient occlusion grounding every building, tree and rock, and a triplanar concrete grain on all structures
